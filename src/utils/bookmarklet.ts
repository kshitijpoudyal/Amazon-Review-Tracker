...
function _bookmarkletSource() {
  ...
  const payload = { retailer: 'amazon', orderDate, orderNumber, orderTotal, productName, productUrl, imageUrl };
...
function withRetailer(payload: BookmarkletPayload): BookmarkletPayload {
...
export function parseBookmarkletClipboard(text: string): BookmarkletPayload {
  ...
  if (trimmed.startsWith('{')) {
    ...
    return withRetailer(parsed as BookmarkletPayload);
  }
