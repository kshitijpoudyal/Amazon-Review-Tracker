...
const AddProductForm: React.FC<AddProductFormProps> = ({ onAdd, onCancel }) => {
  ...
  const modalContent = (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center p-2 sm:p-4">
      <div
        className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] shadow-2xl relative flex flex-col"
